        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800 transition-colors duration-200">
            {perms.map((perm) => {
              ...
              return (
                <tr key={permId} className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors duration-200">
                  ...
                  <td className="px-6 py-4">
                    <code className="text-xs px-2 py-1 rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-mono border border-slate-200 dark:border-slate-700 transition-colors duration-200">
                      {perm.slug}
                    </code>
                  </td>
  ...
  return (
    <div className="p-2 sm:p-4 space-y-6 bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-slate-100 transition-colors duration-200">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white transition-colors duration-200">Permissions Directory</h1>
              ...
              <div className="p-6 space-y-4">
                {[...Array(3)].map((_, itemIdx) => (
                  <div key={itemIdx} className="flex justify-between items-center pt-2">
                    ...
                    <div className="h-6 bg-slate-200 dark:bg-slate-800 rounded w-28" />
          ...
          <EmptyState
            ...
            action={
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-950 rounded-lg transition-colors duration-200"
              >
