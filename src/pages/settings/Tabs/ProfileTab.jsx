      ...
      <div className="px-6 sm:px-7 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <div className="flex items-center gap-3 px-3.5 py-2.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex items-center gap-3 px-3.5 py-2.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl">
              <Badge className="w-4 h-4 text-gray-400 dark:text-slate-500" />
              <span className="text-sm text-gray-900 dark:text-slate-100">
        ...
        {/* VIEW ONLY FOOTER */}
        <div className="pt-4 flex items-center justify-end border-t border-gray-100 dark:border-slate-800 -mx-6 sm:-mx-7 px-6 sm:px-7 mt-2">
